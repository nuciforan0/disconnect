    ...
    return (
      <div className="text-center py-12">
        <div className="max-w-md mx-auto">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">No new videos</h3>
          <p className="text-gray-600 mb-6">
            No new videos from your subscriptions in the last 24 hours. Click "Sync Videos" to check for updates.
          </p>
        </div>
      </div>
    )
